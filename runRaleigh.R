...
source("/Users/akdes/Library/CloudStorage/Box-Box/baylor/codebase/casper_utility_functions/casper_human_func.R")
...
setwd("/Users/akdes/Library/CloudStorage/Box-Box/baylor//arya_akash_rnaseq_classifier/")
load("/Users/akdes/Library/CloudStorage/Box-Box/baylor/meningioma_raleigh_hongkong/Inhouse_Raleigh_RNA_Seq_Combined.rda")
data_GS <- data
...
rownames(samplesheet)[186:429] <- make.unique(samples[match(rownames(samplesheet)[186:429], samples$ExpressionID),"Sample.Name"])
colnames(normalized_data_GS)[186:429] <- make.unique(samples[match(colnames(normalized_data_GS)[186:429], samples$ExpressionID),"Sample.Name"])
colnames(data_GS)[186:429] <- make.unique(samples[match(colnames(data_GS)[186:429], samples$ExpressionID),"Sample.Name"])
...
save(list=c("bulk_count_data", "bulk_normalized_data", "samples", "seurat_obj"), file="Raleigh_Meningioma_Data.Rdata")
...
setwd("/Users/akdes/Library/CloudStorage/Box-Box/baylor//arya_akash_rnaseq_classifier/")
load("Raleigh_Meningioma_Data.Rdata")
source("/Users/akdes/Library/CloudStorage/Box-Box/baylor/codebase/casper_utility_functions/casper_human_func.R")
...
openxlsx::write.xlsx(results, file = "/Users/akdes/Raleigh_CLIPPR_results.xlsx")
...
pdf("heatmap_Raleigh.pdf", width=10, height=50)
p
dev.off()
